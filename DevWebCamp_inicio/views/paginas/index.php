...
<section class="speakers">
    ...
    <?php foreach($ponentes as $ponente){ ?>
        ...
        <picture>
            <source srcset="<?php echo $_ENV['HOST']; ?>/img/speakers/<?php echo $ponente->imagen;?>.webp" type="image/webp">
            <source srcset="<?php echo $_ENV['HOST']; ?>/img/speakers/<?php echo $ponente->imagen;?>.png" type="image/png">
            <img class="speaker__imagen" loading="lazy" width="200" height="300" src="<?php echo $_ENV['HOST']; ?>/img/speakers/<?php echo $ponente->imagen;?>.png" alt="Imagen Ponente">
        </picture>
        <div class="speaker__informacion">
            <h2 class="speaker__nombre"><?php echo $ponente->nombre . ' ' . $ponente->apellido; ?></h2>
        </div>
...
<div data-aos="<?php aos_animacion(); ?>" class="mapa" id="mapa"></div>
